...
CONFIG=config.yml 
OUTPUTBASE=minimal 
report: .files/100_simulation_None .files/100_hospitalization_None_high .files/100_hospitalization_None_med .files/100_hospitalization_None_low
...
.files/1_hospitalization_None_high: .files/1_simulation_None
	$(RSCRIPT) $(PIPELINE)/R/scripts/hosp_run.R -c $(CONFIG) -s None -d high -j $(NCOREPER)
	touch .files/1_hospitalization_None_high
.files/1_hospitalization_None_med: .files/1_simulation_None
	$(RSCRIPT) $(PIPELINE)/R/scripts/hosp_run.R -c $(CONFIG) -s None -d med -j $(NCOREPER)
	touch .files/1_hospitalization_None_med
.files/1_hospitalization_None_low: .files/1_simulation_None
	$(RSCRIPT) $(PIPELINE)/R/scripts/hosp_run.R -c $(CONFIG) -s None -d low -j $(NCOREPER)
